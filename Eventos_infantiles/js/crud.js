...
const PLACEHOLDER_IMAGE =
  "https://images.unsplash.com/photo-1575425186775-b8de9a427e67?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1587&q=80";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("click", actualizarSalon);
  document
    .getElementById("btn-delete-saloon")
    .addEventListener("click", borrarSalon);
});
...
function abrirModalEliminar(id) {
  ...
  document.getElementById("delete-saloon-location").textContent =
    salon.ubicacion;
  document.getElementById("delete-saloon-capacity").textContent =
    salon.capacidad;
  ...
  data.forEach((item) => {
    ...
    salonCard.innerHTML = `
                    <div class="card h-100 salon-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title fw-bold mt-4">${
                              item.nombre
                            }</h5>
